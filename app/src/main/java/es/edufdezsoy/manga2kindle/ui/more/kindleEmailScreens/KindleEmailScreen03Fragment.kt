...
import kotlinx.android.synthetic.main.fragment_kindle_email_screen03.view.*
...
class KindleEmailScreen03Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_kindle_email_screen03, container, false)

        view.dot1_imageView.isEnabled = false
        view.dot2_imageView.isEnabled = false
        view.dot3_imageView.isEnabled = true
